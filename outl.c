...
// don't try putting void in the following ... it must be a macro that already includes it.
...
void print_page(HPDF_Page page, int page_num)
{
    ...
    // Note set page width and height in points.
    HPDF_Page_SetWidth(page, 595.276);
    HPDF_Page_SetHeight(page, 841.89);
